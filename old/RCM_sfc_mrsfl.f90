...
real, dimension(:,:), allocatable  :: wrfv2D,outvar_i
...
!
outfile=trim(vaid)//trim(outdom)//'6hr_'//ayeari//amonth//'0100-'//ayearf//amonth//adayf//ahourf//'.nc'
