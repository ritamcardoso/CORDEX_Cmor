...
real, dimension(:,:), allocatable  :: wrfv2D,outvar,outvar_i,u_s,v_s
...
!
outfile=trim(dir2)//trim(vaid)//trim(outdom)//'1hr_'//ayeari//amonthi//adayi//ahouri//'-'//ayearf//amonthf//adayf//ahourf//'.nc'
