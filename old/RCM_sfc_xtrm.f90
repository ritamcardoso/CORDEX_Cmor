...
integer :: year,month,day,mydays,hour,dhour,nhours,ydays
integer :: ntime
...
real, dimension(:,:), allocatable  :: wrfv2D,outvar
...
!
        filename=trim(dir2)//trim(wrfile)//'_d0'//trim(dom)//'_'//ayear//'-'//amonth//'-'//aday//'_00_00_00'
...
!
outfile=trim(vaid)//trim(outdom)//'day_'//ayeari//amonthi//adayi//'00-'//ayearf//amonthf//adayf//'00.nc'
...
status = nf90_put_att(ncid, nf90_global, "simulation_start_date","2015-01-01_00:00:00")
