...
real, dimension(:,:), allocatable :: wrfv2D, i_wrfv2D, outvar_u, outvar_v
real, dimension(:,:), allocatable :: rainc, rainnc, i_rainc, i_rainnc, rainsh

! 3D WRF In/Out Arrays
real, dimension(:,:,:), allocatable :: outvar_h_u, outvar_h_v, wrfv3D
...
!
        outvar_u(isx,isy)=u_int*cosalp(isx,isy)-v_int*sinalp(isx,isy)
        outvar_v(isx,isy)=v_int*cosalp(isx,isy)+u_int*sinalp(isx,isy)
