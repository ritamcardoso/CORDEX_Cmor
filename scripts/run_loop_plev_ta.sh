#!/bin/sh
#SBATCH --job-name=loop-plev_ta
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=2:50:00
#SBATCH --hint=nomultithread
#SBATCH --output=loop-plev_ta.%j.out
#SBATCH --error=loop-plev_ta.%j.out
...
##### Submit as run_loop_plev_ta.sh date1 date2 date3  (yyyymmdd yyyymmdd yyyy)
