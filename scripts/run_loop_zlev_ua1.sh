...
#SBATCH --job-name=loop-zlev_1ua
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=1:50:00
#SBATCH --hint=nomultithread
#SBATCH --output=loop-zlev_1ua.%j.out
#SBATCH --error=loop-zlev_1ua.%j.out
...
##### Submit as run_loop_zlev_ua1.sh date1 date2 date3  (yyyymmdd yyyymmdd yyyy)
...
yeari=$(( $yeari - 1 ))
  ...
  for (( v=0; v<${#var[@]}; v++)); do
#
  scp ${var[$v]}_*.nc wrf@nimbus.degge.fc.ul.pt:/media/Synology14/CORDEX_CMIP6/scenarios/output/ssp370/${var[$v]}/raw
#
done
