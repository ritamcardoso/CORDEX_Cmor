...
# 2. Compile program
#   
      $FC $FFLAGS ${PROG_DIR}/RCM_sfc_xtrm.f90 ${MOD_NAME}.o ${SUB_NAME}.o -o RCM_sfc_xtrm.exe $ALL_LIBS
...
# sbatch --file=slurm_common.opts run_loop_wxtrm.sh ${datebeg} ${dateend} ${year_lim}
