#!/bin/sh
#SBATCH --job-name=wrf-ua0
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=16:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-ua0.%j.out
#SBATCH --error=wrf-ua0.%j.out
...
# sbatch --file=slurm_common.opts run_loop_zlev_ua0.sh ${datebeg} ${dateend} ${year_lim}
