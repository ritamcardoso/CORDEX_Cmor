...
#SBATCH --job-name=loop-plev_va
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=4:50:00
#SBATCH --hint=nomultithread
#SBATCH --output=loop-plev_va.%j.out
#SBATCH --error=loop-plev_va.%j.out
...
##### Submit as run_loop_plev_va.sh date1 date2 date3  (yyyymmdd yyyymmdd yyyy)
