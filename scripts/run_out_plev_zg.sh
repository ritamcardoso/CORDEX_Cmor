#!/bin/sh
#SBATCH --job-name=wrf-zg
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=14:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-zg.%j.out
#SBATCH --error=wrf-zg.%j.out
...
# 2. Compile program
#
   $FC $FFLAGS ${PROG_DIR}/RCM_plev_zg.f90 ${MOD_NAME}.o ${SUB_NAME}.o -o RCM_plev_zg.exe $ALL_LIBS
...
# sbatch --file=slurm_common.opts run_loop_plev_zg.sh ${datebeg} ${dateend} ${year_lim}
