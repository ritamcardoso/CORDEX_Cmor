#!/bin/sh
#SBATCH --job-name=wrf-va0
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=16:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-va0.%j.out
#SBATCH --error=wrf-va0.%j.out
...
declare -a run=("d01")
declare -a var=("va50m" "va150m" "va100m")
...
# 2. Compile program
#
   $FC $FFLAGS ${PROG_DIR}/RCM_zlev_va.f90 ${MOD_NAME}.o ${SUB_NAME}.o -o RCM_zlev_va.exe $ALL_LIBS
...
# sbatch --file=slurm_common.opts run_loop_zlev_va0.sh ${datebeg} ${dateend} ${year_lim}
