...
#SBATCH --job-name=loop-zlev_ta
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=50:00
#SBATCH --hint=nomultithread
#SBATCH --output=loop-zlev_ta.%j.out
#SBATCH --error=loop-zlev_ta.%j.out
...
##### Submit as run_loop_zlev_ta.sh date1 date2 date3  (yyyymmdd yyyymmdd yyyy)
