...
#SBATCH --job-name=loop-plev_hus
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=50:00
#SBATCH --hint=nomultithread
#SBATCH --output=loop-plev_hus.%j.out
#SBATCH --error=loop-plev_hus.%j.out
...
##### Submit as run_loop_plev_hus.sh date1 date2 date3  (yyyymmdd yyyymmdd yyyy)
