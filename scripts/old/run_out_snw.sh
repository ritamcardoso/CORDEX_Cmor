#!/bin/sh
#SBATCH --job-name=wrf-snw
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=4:30:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-snw.%j.out
#SBATCH --error=wrf-snw.%j.out
...
#  ifort -check all -traceback ${PROG_DIR}/RCM_sfc_${var[$v]}.f90 -o RCM_sfc_${var[$v]}.exe -I/usr/local/apps/netcdf4/${netcdf_v}/INTEL/${intel_v}/include -L/usr/local/apps/netcdf4/${netcdf_v}/INTEL/${intel_v}/lib -lnetcdff -lnetcdf
...
sbatch run_loop_snw.sh ${datebeg} ${dateend} ${year_lim}
