...
#SBATCH --output=wrfsoil1-o.%j.out
#SBATCH --error=wrfsoil1-o.%j.out
...
#declare -a var=("tauu" "tauv" "mrro" "mrros")
#declare -a var=("evpsbl" "mrso" "mrsos" "snc" "snw" "snd" "mrro" "mrros" "tauu" "tauv")
#declare -a var=("mrfso" "mrfsos" "mrso" "mrsos" "snc" "snw" "snd" "mrro" "mrros")
...
cd ..
cd ..
sbatch run_loop_soil1.sh ${datebeg} ${dateend}
echo "$0 done."
