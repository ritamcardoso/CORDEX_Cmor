#!/bin/sh
#SBATCH --job-name=wrfsoil-o
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=16:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrfsoil-o.%j.out
#SBATCH --error=wrfsoil-o.%j.out
...
declare -a var=("tauu"  "tauv" "mrso" "mrsos" "snc" "snw" "snd" "th")
declare -a run=("d01")
...
#
    rsync -avz ${var[$v]}_*.nc wrf@vortex.degge.fc.ul.pt:/media/tor_disk2/data/wrf/CORDEX_CMIP6/output
