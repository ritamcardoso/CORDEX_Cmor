...
#SBATCH --job-name=loop-zlev3_va
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=50:00
#SBATCH --hint=nomultithread
#SBATCH --output=loop-zlev3_va.%j.out
#SBATCH --error=loop-zlev3_va.%j.out
...
if [ $yeari -le 1982 ]; then

  sbatch run_out_zlev_va_asneira.sh ${datebeg} ${dateend}
...
#
  ...
  scp ../output/${var[$v]}_*.nc wrf@vortex.degge.fc.ul.pt:/media/tor_disk2/data/wrf/CORDEX_CMIP6/output
#
done
