#!/bin/sh
#SBATCH --job-name=wrf-0zlevua
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=15:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-0zlevua.%j.out
#SBATCH --error=wrf-0zlevua.%j.out
...
#                           TO CHANGE                           |
#----------------------------------------------------------------
RUN_DIR=$SCRATCH/ssp370/zlev_ua0
mkdir -p ssp370/zlev_ua0

declare -a run=("d01")
declare -a var=("ua50m" "ua150m" "ua100m")
...
sbatch run_loop_zlev_ua0.sh ${datebeg} ${dateend} ${year_lim}
