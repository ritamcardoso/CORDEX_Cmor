#!/bin/sh
#SBATCH --job-name=wrf-cld1
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=13:30:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-cld1.%j.out
#SBATCH --error=wrf-cld1.%j.out
...
sbatch run_loop_cld1.sh ${datebeg} ${dateend} ${year_lim}
