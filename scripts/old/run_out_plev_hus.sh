#!/bin/sh
#SBATCH --job-name=wrf-plevhus
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=12:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-plevhus.%j.out
#SBATCH --error=wrf-plevhus.%j.out
...
sbatch run_loop_plev_hus.sh ${datebeg} ${dateend} ${year_lim}
