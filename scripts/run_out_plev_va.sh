...
# 2. Compile program
#
   $FC $FFLAGS ${PROG_DIR}/RCM_plev_va.f90 ${MOD_NAME}.o ${SUB_NAME}.o -o RCM_plev_va.exe $ALL_LIBS
...
# sbatch --file=slurm_common.opts run_loop_plev_va.sh ${datebeg} ${dateend} ${year_lim}
