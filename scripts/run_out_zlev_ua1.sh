#!/bin/sh
#SBATCH --job-name=wrf-ua1
#SBATCH --qos=nf
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=16:00:00
#SBATCH --hint=nomultithread
#SBATCH --output=wrf-ua1.%j.out
#SBATCH --error=wrf-ua1.%j.out
...
# 2. Compile program
#
   $FC $FFLAGS ${PROG_DIR}/RCM_zlev_ua.f90 ${MOD_NAME}.o ${SUB_NAME}.o -o RCM_zlev_ua.exe $ALL_LIBS
...
# sbatch --file=slurm_common.opts run_loop_zlev_ua1.sh ${datebeg} ${dateend} ${year_lim}
